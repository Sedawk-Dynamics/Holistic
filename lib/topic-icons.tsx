...
/**
 * Line-icon path fragments shared by the topic pages. Each value is the inner
 * markup of a 24x24 stroked <svg>; the page wraps it. 1.6-ish stroke, round caps
 * — the same style as every other icon on the site.
 */
export const ICON: Record<string, ReactNode> = {
  ...
  handshake: (
    <>
      ...
      <path d="m21 3-9.19 9.19a1 1 0 0 1-1.42 0l-2.11-2.11a1 1 0 0 1 0-1.42L15.87 1" />
    </>
  ),
  shield: (
    <>
  ...
  palette: (
    <>
      ...
      <path d="M12 2a10 10 0 1 0 0 20 1.5 1.5 0 0 0 1.1-2.5 1.5 1.5 0 0 1 1.1-2.5H16a6 6 0 0 0 6-6 10 10 0 0 0-10-9z" />
    </>
  ),
  graduation: (
    <>
  ...
  memory: (
    <>
      <circle cx="12" cy="12" r="10" />
      <path d="M12 8a2 2 0 0 0-2 2c0 1 .5 1.5 1 2s1 1 1 2" />
      <path d="M12 16h.01" />
    </>
  ),
  plane: (
